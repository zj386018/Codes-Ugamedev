...
class GameGUI:
    ...
    def create_widgets(self):
        ...
        main_frame.pack_configure(padx=10, pady=10)
    ...
    def create_info_bar(self, parent):
        ...
        title_label.pack_configure(padx=20)
    ...
    def create_game_area(self, parent):
        ...
        self.scene_title = tk.Label(game_frame, text="", bg='#2b2b2b', fg='#4CAF50', 
                                   font=('微软雅黑', 16, 'bold'))
        self.scene_title.pack(pady=(0, 10))
    ...
    def create_inventory_area(self, parent):
        ...
        inventory_frame.pack(side=tk.RIGHT, fill=tk.Y, padx=(5, 0))
        ...
        self.inventory_listbox.pack(fill=tk.BOTH, expand=True, padx=10, pady=(0, 10))
        ...
        self.item_description.pack(fill=tk.X, padx=10, pady=(0, 10))
        ...
        self.use_item_btn.pack(pady=(0, 10))
    ...
    def create_control_bar(self, parent):
        ...
        restart_btn.pack(side=tk.LEFT, padx=10, pady=10)
    ...
    def load_scene(self, scene_id):
        ...
        for i, (choice_text, next_scene) in enumerate(self.current_scene.choices):
            btn = tk.Button(
                ...
                font=('微软雅黑', 11),
                relief=tk.FLAT,
                command=lambda ns=next_scene, b=btn: self.on_choice_click(ns, b),
                wraplength=400,
                justify=tk.LEFT,
                pady=8
            )
